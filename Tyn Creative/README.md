...
Welcome to the **TYN Creative** project! This is a futuristic landing page designed with a dark cyberpunk theme, showcasing the creative capabilities of our studio. The project utilizes modern web technologies including React, TypeScript, Vite, Three.js (React Three Fiber), GSAP, and Framer Motion to deliver a visually stunning and interactive experience.
...
To get started with the **TYN Creative** project, follow these steps:

1. **Clone the Repository**:

```bash
git clone https://github.com/eyunt16/tyncreative-portfolio
cd tyncreative-portfolio
```
...
Thank you for checking out the **TYN Creative** project! We hope you enjoy exploring our creative work and the technologies that power this landing page.
